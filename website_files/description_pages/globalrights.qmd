...
👉 [Launch on Binder](https://mybinder.org/v2/gh/jadeeechen/diversedata-notebooks/HEAD?urlpath=lab/tree/globalrights.ipynb){target="_blank" rel="noopener"}

:::

## About the Data

This dataset provides yearly, country-level information on LGBTQ+ rights, economic indicators, and education spending from 2001 to 2023. It is compiled from Our World in Data, with primary sources including Equaldex, the World Bank, and other open-access data sets.
...
| `country-code`             | ID       | String      | ISO 3-letter country code                                                                    | -               | Yes            |
...
| `same-sex-marriage`        | Target   | Categorical | Legal status of same-sex marriage (e.g., "Legal", "Varies by region",  "Unecognized")                 | -               | Yes            |
...
| `legal-gender`             | Feature  | Categorical | Whether legal gender can be changed and under what conditions (e.g., "Legal, no restrictions", "Ambiguous")  | -               | Yes            |
