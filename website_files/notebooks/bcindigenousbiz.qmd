...
::: {.panel-tabset}
## R
```{r eda_2, warning=FALSE, message=FALSE, fig.width=7, fig.height=9}
# Create leaflet map
indigenousbiz_data |>
  leaflet() |>
  addTiles() |>
...
fig_treemap = px.treemap(
    ...
    title="Top Industry Sectors by Geo Cluster",
    subtitle="Note: R and Python cluster labels differ",
)
...
fig_treemap = fig_treemap.update_layout(margin=dict(l=10, r=10, t=50, b=10))
```
