...
## Python
```{python simple_bar_py, fig.height=4, fig.width=8}
...
```{python histograms_py, fig.height=20, fig.width=8}
sex_freq_labels = {
  "once_a_month_or_less": "Once a Month or Less",
  "2_to_3_times_a_month": "Two or Three Times a Month",
  "once_or_twice_a_week": "Once or Twice a Week",
...
```{python fit_model_py, output = FALSE}
...
```{python baseline_model_metrics_py, warnings = FALSE}
print(
    classification_report(
        y_test,
        baseline_y_pred,
