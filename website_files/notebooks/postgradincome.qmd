...
income_data = pd.read_csv("../../data/clean/postgradincome.csv")
...
# (This acts like the aes(weight = ...) parameter in R)
...
# Format labels and axes
ax.set_title("Median Income Distribution by Population Group", fontsize=13, pad=15, loc='left')
ax.text(
...
ax.set_title("Median Income Distribution by Educational Qualification", fontsize=13, pad=15, loc='left')
ax.text(
    0.0, 1.02, "Ordered by Median Income", 
    transform=ax.transAxes, fontsize=10, color="gray"
)
...
ax.set_title("Median Income Distribution by Field of Study", fontsize=13, pad=15, loc='left')
ax.text(
    0.0, 1.02, "Ordered by Median Income", 
    transform=ax.transAxes, fontsize=10, color="gray"
)
