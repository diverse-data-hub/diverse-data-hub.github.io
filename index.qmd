...
To install the `diversedata` packages from GitHub, follow the instructions below:
...
- `Python` (>= 3.8) & `pip`: Download from [python.org](https://www.python.org/) (use a virtual environment)
